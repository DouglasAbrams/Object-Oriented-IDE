...
>>>>>>> 05d980b1038f7c6f95879906d4f6e6f9e23430f4
...
public class Parser {
    ...
    private Class_ parseClass() {
        int position = currentToken.position;
<<<<<<< HEAD
        if (currentToken.kind == CLASS){    //handle "Class"
            scanner.scan();
            parseIdentifier();
        ...
        if(currentToken.kind == EXTENDS){ //handle extends clause
            parseIdentifier()
            scanner.scan();
...
<<<<<<< HEAD
        if(currentToken.kind != RETURN){
            handleUnexpectedToken("midding return");
        }
    }
=======
...
>>>>>>> 05d980b1038f7c6f95879906d4f6e6f9e23430f4
     ...
     */
<<<<<<< HEAD
    private Expr parseUnaryPrefix() {  //really simplfy
...
<<<<<<< HEAD
        while (currentToken.kind != EMPTY){//**//
            Expr expr = parseExpression();
            flist.addElement(expr);
            scanner.scan();
            if (currentToken.kind != COMMA){
                handleUnexpectedToken("missing comma")
            }
        }
        return exprList;
    }
...
>>>>>>> 05d980b1038f7c6f95879906d4f6e6f9e23430f4
    ...
    private FormalList parseParameters() {
        int position = currentToken.position;
<<<<<<< HEAD
        FormalList flist = new FormalList(position);
        while (currentToken.kind != EMPTY){//**//
            Formal formal = parseFormal();
            flist.addElement(formal);
            scanner.scan();
            if (currentToken.kind != COMMA){
                handleUnexpectedToken("missing comma")
            }
...
<<<<<<< HEAD
    ...
    private String parseType() {
        String identifier = parseIdentifier();
        scanner.scan();
        if (currentToken.kind == EMPTY){
            return identifier;
        }
        if (currentToken.kind != LBRACKET){
            handleUnexpectedToken("missing identifier");
        }
        scanner.scan();
        if (currentToken.kind != RBRACKET){
            handleUnexpectedToken("missing identifier");
